...
class constants:
	...
	psSubtract                    =0x1d       # from enum PsBlendMode
	...
	psSubtractBlend               =0x1b       # from enum PsColorBlendMode
	...
	psBlackAndWhiteLayer          =0x16       # from enum PsLayerKind
	...
	psExposureLayer               =0x13       # from enum PsLayerKind
	...
	psLayer3D                     =0x14       # from enum PsLayerKind
	...
	psPhotoFilterLayer            =0x12       # from enum PsLayerKind
	...
	psVibrance                    =0x17       # from enum PsLayerKind
	psVideoLayer                  =0x15       # from enum PsLayerKind
	...
	psActiveMeasurements          =0x2        # from enum PsMeasurementRange
	psAllMeasurements             =0x1        # from enum PsMeasurementRange
	psMeasureCountTool            =0x2        # from enum PsMeasurementSource
	psMeasureRulerTool            =0x3        # from enum PsMeasurementSource
	psMeasureSelection            =0x1        # from enum PsMeasurementSource
	...
	psDICOMOpen                   =0x21       # from enum PsOpenDocumentType
	...
	psPDF17                       =0x5        # from enum PsPDFCompatibilityType
	...
	psPDFX42008                   =0x5        # from enum PsPDFStandardType
...
class ArtLayer(DispatchBaseClass):
	...
	def ApplyRadialBlur(self, Amount=defaultNamedNotOptArg, BlurMethod=defaultNamedNotOptArg, BlurQuality=defaultNamedNotOptArg):
		...
		return self._oleobj_.InvokeTypes(1177563188, LCID, 1, (24, 0), ((3, 1), (3, 1), (3, 1)),Amount
			, BlurMethod, BlurQuality)
...
class ColorSamplers(DispatchBaseClass):
	...
	def Add(self, Position=defaultNamedNotOptArg):
		...
		if ret is not None:
			ret = Dispatch(ret, 'Add', '{B125A66B-4C94-4E55-AF2F-57EC4DCB484B}', UnicodeToString=0)
		return ret
	...
	def Item(self, ItemKey=defaultNamedNotOptArg):
		...
		if ret is not None:
			ret = Dispatch(ret, 'Item', '{B125A66B-4C94-4E55-AF2F-57EC4DCB484B}', UnicodeToString=0)
		return ret
	...
	def __call__(self, ItemKey=defaultNamedNotOptArg):
		...
		if ret is not None:
			ret = Dispatch(ret, '__call__', '{B125A66B-4C94-4E55-AF2F-57EC4DCB484B}', UnicodeToString=0)
		return ret
	...
	def _NewEnum(self):
		"Create an enumerator from this object"
		return win32com.client.util.WrapEnum(self._oleobj_.InvokeTypes(-4,LCID,2,(13, 10),()),'{B125A66B-4C94-4E55-AF2F-57EC4DCB484B}')
	def __getitem__(self, index):
		"Allow this class to be accessed as a collection"
		if not self.__dict__.has_key('_enum_'):
			self.__dict__['_enum_'] = self._NewEnum()
...
class CountItems(DispatchBaseClass):
	...
	def Add(self, Position=defaultNamedNotOptArg):
		...
		if ret is not None:
			ret = Dispatch(ret, 'Add', '{66869370-9672-492D-93AC-0ADD62F427F1}', UnicodeToString=0)
		return ret
	...
	def Item(self, ItemKey=defaultNamedNotOptArg):
		...
		if ret is not None:
			ret = Dispatch(ret, 'Item', '{66869370-9672-492D-93AC-0ADD62F427F1}', UnicodeToString=0)
		return ret
	...
	def __call__(self, ItemKey=defaultNamedNotOptArg):
		...
		if ret is not None:
			ret = Dispatch(ret, '__call__', '{66869370-9672-492D-93AC-0ADD62F427F1}', UnicodeToString=0)
		return ret
	...
	def _NewEnum(self):
		"Create an enumerator from this object"
		return win32com.client.util.WrapEnum(self._oleobj_.InvokeTypes(-4,LCID,2,(13, 10),()),'{66869370-9672-492D-93AC-0ADD62F427F1}')
	def __getitem__(self, index):
		"Allow this class to be accessed as a collection"
		if not self.__dict__.has_key('_enum_'):
			self.__dict__['_enum_'] = self._NewEnum()
...
class Document(DispatchBaseClass):
	...
	def ResizeImage(self, Width=defaultNamedOptArg, Height=defaultNamedOptArg, Resolution=defaultNamedOptArg, ResampleMethod=defaultNamedOptArg):
		...
		return self._oleobj_.InvokeTypes(1383745901, LCID, 1, (24, 0), ((12, 17), (12, 17), (12, 17), (12, 17)),Width
			, Height, Resolution, ResampleMethod)
...
class PathItem(DispatchBaseClass):
	...
	def Duplicate(self, Name=defaultNamedOptArg):
		...
		if ret is not None:
			ret = Dispatch(ret, 'Duplicate', '{8B0CB532-4ACC-4BF3-9E42-0949B679D120}', UnicodeToString=0)
		return ret
...
class _ActionDescriptor(DispatchBaseClass):
	...
	coclass_clsid = IID('{9EE48E8D-E8C5-41B8-82D3-966D5CE4DE6E}')
...
class _ActionList(DispatchBaseClass):
	...
	coclass_clsid = IID('{82E8A02B-F8EB-4F72-B691-4F347FB05F96}')
...
class _ActionReference(DispatchBaseClass):
	...
	coclass_clsid = IID('{DE64233A-E11D-4554-B8FD-C10642D3C779}')
...
class _Application(DispatchBaseClass):
	...
	coclass_clsid = IID('{D9389EDE-AEF8-4092-9377-075E94B7CB9A}')
...
class _BMPSaveOptions(DispatchBaseClass):
	...
	coclass_clsid = IID('{0194FCAC-7ED4-4552-BAC7-BFD4D4E4FCFF}')
...
class _BatchOptions(DispatchBaseClass):
	...
	coclass_clsid = IID('{2F30577D-2958-428D-954D-42D78D046D9E}')
...
class _BitmapConversionOptions(DispatchBaseClass):
	...
	coclass_clsid = IID('{DFB392EF-085E-4576-B96C-1CB253817E36}')
...
class _CMYKColor(DispatchBaseClass):
	...
	coclass_clsid = IID('{0901CE4F-96EE-4C25-9FCB-34835BD80531}')
...
class _CameraRAWOpenOptions(DispatchBaseClass):
	...
	coclass_clsid = IID('{75BF0078-35B3-41CD-B8B6-790415C9126C}')
...
class _ContactSheetOptions(DispatchBaseClass):
	...
	coclass_clsid = IID('{0D014F5C-8898-4477-B99A-4F5ACEA4E253}')
...
class _DCS1_SaveOptions(DispatchBaseClass):
	...
	coclass_clsid = IID('{A5FDBB10-1148-4014-AC7A-A710D789AC76}')
...
class _DCS2_SaveOptions(DispatchBaseClass):
	...
	coclass_clsid = IID('{61308800-CAE8-474E-9241-5D45EC4C0B59}')
...
class _DICOMOpenOptions(DispatchBaseClass):
	...
	coclass_clsid = IID('{A190F1A7-8DD0-4D60-ADC2-E1B1AE6882BD}')
...
class _EPSOpenOptions(DispatchBaseClass):
	...
	coclass_clsid = IID('{84EE10CC-61DD-4F8C-82EB-13198358996B}')
...
class _EPSSaveOptions(DispatchBaseClass):
	...
	coclass_clsid = IID('{020C962D-F4F9-4973-971F-8083C9B8D99E}')
...
class _ExportOptionsIllustrator(DispatchBaseClass):
	...
	coclass_clsid = IID('{F0DAEE0E-C63D-4E0B-8D6A-BC6FC6886711}')
...
class _ExportOptionsSaveForWeb(DispatchBaseClass):
	...
	coclass_clsid = IID('{E490EE52-1579-4440-B20F-56299E7BB000}')
...
class _GIFSaveOptions(DispatchBaseClass):
	...
	coclass_clsid = IID('{E1D378B4-78DD-46BF-95A0-9963114EDFF8}')
...
class _GalleryBannerOptions(DispatchBaseClass):
	...
	coclass_clsid = IID('{FF50BA4E-BA40-4202-A111-543A0F4CB701}')
...
class _GalleryCustomColorOptions(DispatchBaseClass):
	...
	coclass_clsid = IID('{28D58674-3C72-448F-A6DF-D13AAEBA90D1}')
...
class _GalleryImagesOptions(DispatchBaseClass):
	...
	coclass_clsid = IID('{8A8974AE-0BE2-4AB5-8518-94E6F27A8DC1}')
...
class _GalleryOptions(DispatchBaseClass):
	...
	coclass_clsid = IID('{E68AB4B1-0182-409F-A657-1B1027B93A80}')
...
class _GallerySecurityOptions(DispatchBaseClass):
	...
	coclass_clsid = IID('{1FCF72FE-56FC-40EF-9409-3B15E524CF57}')
...
class _GalleryThumbnailOptions(DispatchBaseClass):
	...
	coclass_clsid = IID('{8F308687-025F-4FB2-8BC0-40E106E3760B}')
...
class _GrayColor(DispatchBaseClass):
	...
	coclass_clsid = IID('{6DA9D53F-4FE6-42AB-A6B9-88EB5A1A2926}')
...
class _HSBColor(DispatchBaseClass):
	...
	coclass_clsid = IID('{6B4CAEF5-1043-477C-87CA-C27EF3A91CE9}')
...
class _IndexedConversionOptions(DispatchBaseClass):
	...
	coclass_clsid = IID('{C32A7B74-655B-44DD-A870-2655FAAAEC45}')
...
class _JPEGSaveOptions(DispatchBaseClass):
	...
	coclass_clsid = IID('{C5DD0937-8830-4F5B-A0B1-0F010F2BA763}')
...
class _LabColor(DispatchBaseClass):
	...
	coclass_clsid = IID('{86D61CD0-22FE-422C-BA9E-7724EFAEE6A9}')
...
class _NoColor(DispatchBaseClass):
	...
	coclass_clsid = IID('{EB61937C-1545-4EF5-AE02-0DAAC31FC9C2}')
...
class _PDFOpenOptions(DispatchBaseClass):
	...
	coclass_clsid = IID('{620205C8-6CC8-4B06-A1ED-25CD6993C1D6}')
...
class _PDFSaveOptions(DispatchBaseClass):
	...
	coclass_clsid = IID('{A7D0B9FD-0113-4DC1-BD85-22A5F4F0CF06}')
...
class _PICTFileSaveOptions(DispatchBaseClass):
	...
	coclass_clsid = IID('{04ABB7FD-89F6-4BCC-A33F-D0DCB1FA72A6}')
...
class _PNGSaveOptions(DispatchBaseClass):
	...
	coclass_clsid = IID('{F71FE2A9-30F1-48F9-824B-4D0971A34355}')
...
class _PathPointInfo(DispatchBaseClass):
	...
	coclass_clsid = IID('{7282C694-D0F9-4C96-8494-716551081A2B}')
...
class _PhotoCDOpenOptions(DispatchBaseClass):
	...
	coclass_clsid = IID('{A5320D4D-0784-4083-9ABF-E2B66E46F420}')
...
class _PhotoshopSaveOptions(DispatchBaseClass):
	...
	coclass_clsid = IID('{EFE476D2-BB9F-449B-9B6D-FE71B42A40B2}')
...
class _PicturePackageOptions(DispatchBaseClass):
	...
	coclass_clsid = IID('{B8AEDDD5-2D78-4365-9D41-14A7610A193E}')
...
class _PixarSaveOptions(DispatchBaseClass):
	...
	coclass_clsid = IID('{2774A466-12A0-4658-A019-B4D5213D9D20}')
...
class _PresentationOptions(DispatchBaseClass):
	...
	coclass_clsid = IID('{B434E847-DEAD-4AA7-8F3F-5B7DD59A7554}')
...
class _RGBColor(DispatchBaseClass):
	...
	coclass_clsid = IID('{F491AFF3-A34F-4BC0-BA31-E57527BB55BA}')
...
class _RawFormatOpenOptions(DispatchBaseClass):
	...
	coclass_clsid = IID('{340311C5-3903-400C-85B0-F966EBF9C9C8}')
...
class _RawSaveOptions(DispatchBaseClass):
	...
	coclass_clsid = IID('{E7B57839-407D-4C32-B8C9-2847EFCF7555}')
...
class _SGIRGBSaveOptions(DispatchBaseClass):
	...
	coclass_clsid = IID('{BEB8EB29-7BDA-4979-995A-2215A403353D}')
...
class _SolidColor(DispatchBaseClass):
	...
	coclass_clsid = IID('{135F725E-9C7D-4D86-8DDB-A82997C0E702}')
...
class _SubPathInfo(DispatchBaseClass):
	...
	coclass_clsid = IID('{681135A5-60D1-47FB-AB03-D669CC35CD15}')
...
class _TargaSaveOptions(DispatchBaseClass):
	...
	coclass_clsid = IID('{C3DAF984-C427-432F-8E48-996B5899436B}')
...
class _TiffSaveOptions(DispatchBaseClass):
	...
	coclass_clsid = IID('{F2F94B1A-735E-48CD-AF5C-9034989100C8}')
...
# This CoClass is known by the name 'Photoshop.ActionDescriptor.12'
class ActionDescriptor(CoClassBaseClass): # A CoClass
	CLSID = IID('{9EE48E8D-E8C5-41B8-82D3-966D5CE4DE6E}')
	coclass_sources = [
	]
	coclass_interfaces = [
		_ActionDescriptor,
...
# This CoClass is known by the name 'Photoshop.ActionList.12'
class ActionList(CoClassBaseClass): # A CoClass
	CLSID = IID('{82E8A02B-F8EB-4F72-B691-4F347FB05F96}')
	coclass_sources = [
	]
	coclass_interfaces = [
		_ActionList,
...
# This CoClass is known by the name 'Photoshop.ActionReference.12'
class ActionReference(CoClassBaseClass): # A CoClass
	CLSID = IID('{DE64233A-E11D-4554-B8FD-C10642D3C779}')
	coclass_sources = [
	]
	coclass_interfaces = [
		_ActionReference,
...
# This CoClass is known by the name 'Photoshop.Application.12'
class Application(CoClassBaseClass): # A CoClass
	# The Adobe Photoshop application
	CLSID = IID('{D9389EDE-AEF8-4092-9377-075E94B7CB9A}')
	coclass_sources = [
	]
	coclass_interfaces = [
		_Application,
...
# This CoClass is known by the name 'Photoshop.BMPSaveOptions.12'
class BMPSaveOptions(CoClassBaseClass): # A CoClass
	# Settings related to saving a BMP document
	CLSID = IID('{0194FCAC-7ED4-4552-BAC7-BFD4D4E4FCFF}')
	coclass_sources = [
	]
	coclass_interfaces = [
		_BMPSaveOptions,
...
# This CoClass is known by the name 'Photoshop.BatchOptions.12'
class BatchOptions(CoClassBaseClass): # A CoClass
	# options for the Batch command
	CLSID = IID('{2F30577D-2958-428D-954D-42D78D046D9E}')
	coclass_sources = [
	]
	coclass_interfaces = [
		_BatchOptions,
...
# This CoClass is known by the name 'Photoshop.BitmapConversionOptions.12'
class BitmapConversionOptions(CoClassBaseClass): # A CoClass
	# Settings related to changing the document mode to Bitmap
	CLSID = IID('{DFB392EF-085E-4576-B96C-1CB253817E36}')
	coclass_sources = [
	]
	coclass_interfaces = [
...
# This CoClass is known by the name 'Photoshop.CMYKColor.12'
class CMYKColor(CoClassBaseClass): # A CoClass
	# A CMYK color specification
	CLSID = IID('{0901CE4F-96EE-4C25-9FCB-34835BD80531}')
	coclass_sources = [
	]
	coclass_interfaces = [
		_CMYKColor,
...
# This CoClass is known by the name 'Photoshop.CameraRAWOpenOptions.12'
class CameraRAWOpenOptions(CoClassBaseClass): # A CoClass
	# Settings related to opening a camera RAW document
	CLSID = IID('{75BF0078-35B3-41CD-B8B6-790415C9126C}')
	coclass_sources = [
	]
	coclass_interfaces = [
...
# This CoClass is known by the name 'Photoshop.ContactSheetOptions.12'
class ContactSheetOptions(CoClassBaseClass): # A CoClass
	# Options for the Contact Sheet command
	CLSID = IID('{0D014F5C-8898-4477-B99A-4F5ACEA4E253}')
	coclass_sources = [
	]
	coclass_interfaces = [
...
# This CoClass is known by the name 'Photoshop.DCS1_SaveOptions.12'
class DCS1_SaveOptions(CoClassBaseClass): # A CoClass
	# Settings related to saving a Photoshop DCS 1.0 document
	CLSID = IID('{A5FDBB10-1148-4014-AC7A-A710D789AC76}')
	coclass_sources = [
	]
	coclass_interfaces = [
		_DCS1_SaveOptions,
...
# This CoClass is known by the name 'Photoshop.DCS2_SaveOptions.12'
class DCS2_SaveOptions(CoClassBaseClass): # A CoClass
	# Settings related to saving a Photoshop DCS 2.0 document
	CLSID = IID('{61308800-CAE8-474E-9241-5D45EC4C0B59}')
	coclass_sources = [
	]
	coclass_interfaces = [
		_DCS2_SaveOptions,
...
# This CoClass is known by the name 'Photoshop.DICOMOpenOptions.12'
class DICOMOpenOptions(CoClassBaseClass): # A CoClass
	# Settings related to opening a DICOM document
	CLSID = IID('{A190F1A7-8DD0-4D60-ADC2-E1B1AE6882BD}')
	coclass_sources = [
	]
	coclass_interfaces = [
		_DICOMOpenOptions,
...
# This CoClass is known by the name 'Photoshop.EPSOpenOptions.12'
class EPSOpenOptions(CoClassBaseClass): # A CoClass
	# Settings related to opening a generic EPS document
	CLSID = IID('{84EE10CC-61DD-4F8C-82EB-13198358996B}')
	coclass_sources = [
	]
	coclass_interfaces = [
		_EPSOpenOptions,
...
# This CoClass is known by the name 'Photoshop.EPSSaveOptions.12'
class EPSSaveOptions(CoClassBaseClass): # A CoClass
	# Settings related to saving an EPS document
	CLSID = IID('{020C962D-F4F9-4973-971F-8083C9B8D99E}')
	coclass_sources = [
	]
	coclass_interfaces = [
		_EPSSaveOptions,
...
# This CoClass is known by the name 'Photoshop.ExportOptionsIllustrator.12'
class ExportOptionsIllustrator(CoClassBaseClass): # A CoClass
	# Settings related to exporting Illustrator paths
	CLSID = IID('{F0DAEE0E-C63D-4E0B-8D6A-BC6FC6886711}')
	coclass_sources = [
	]
	coclass_interfaces = [
...
# This CoClass is known by the name 'Photoshop.ExportOptionsSaveForWeb.12'
class ExportOptionsSaveForWeb(CoClassBaseClass): # A CoClass
	# Settings related to exporting Save For Web files
	CLSID = IID('{E490EE52-1579-4440-B20F-56299E7BB000}')
	coclass_sources = [
	]
	coclass_interfaces = [
...
# This CoClass is known by the name 'Photoshop.GIFSaveOptions.12'
class GIFSaveOptions(CoClassBaseClass): # A CoClass
	# Settings related to saving a GIF document
	CLSID = IID('{E1D378B4-78DD-46BF-95A0-9963114EDFF8}')
	coclass_sources = [
	]
	coclass_interfaces = [
		_GIFSaveOptions,
...
# This CoClass is known by the name 'Photoshop.GalleryBannerOptions.12'
class GalleryBannerOptions(CoClassBaseClass): # A CoClass
	# Options for the web photo gallery banner options
	CLSID = IID('{FF50BA4E-BA40-4202-A111-543A0F4CB701}')
	coclass_sources = [
	]
	coclass_interfaces = [
...
# This CoClass is known by the name 'Photoshop.GalleryCustomColorOptions.12'
class GalleryCustomColorOptions(CoClassBaseClass): # A CoClass
	# Options for the web photo gallery colors
	CLSID = IID('{28D58674-3C72-448F-A6DF-D13AAEBA90D1}')
	coclass_sources = [
	]
	coclass_interfaces = [
...
# This CoClass is known by the name 'Photoshop.GalleryImagesOptions.12'
class GalleryImagesOptions(CoClassBaseClass): # A CoClass
	# Options for the web photo gallery images
	CLSID = IID('{8A8974AE-0BE2-4AB5-8518-94E6F27A8DC1}')
	coclass_sources = [
	]
	coclass_interfaces = [
...
# This CoClass is known by the name 'Photoshop.GalleryOptions.12'
class GalleryOptions(CoClassBaseClass): # A CoClass
	# Options for the web photo gallery command
	CLSID = IID('{E68AB4B1-0182-409F-A657-1B1027B93A80}')
	coclass_sources = [
	]
	coclass_interfaces = [
		_GalleryOptions,
...
# This CoClass is known by the name 'Photoshop.GallerySecurityOptions.12'
class GallerySecurityOptions(CoClassBaseClass): # A CoClass
	# Options for the web photo gallery security
	CLSID = IID('{1FCF72FE-56FC-40EF-9409-3B15E524CF57}')
	coclass_sources = [
	]
	coclass_interfaces = [
...
# This CoClass is known by the name 'Photoshop.GalleryThumbnailOptions.12'
class GalleryThumbnailOptions(CoClassBaseClass): # A CoClass
	# Options for the web photo gallery thumbnail creation
	CLSID = IID('{8F308687-025F-4FB2-8BC0-40E106E3760B}')
	coclass_sources = [
	]
	coclass_interfaces = [
...
# This CoClass is known by the name 'Photoshop.GrayColor.12'
class GrayColor(CoClassBaseClass): # A CoClass
	# A gray color specification
	CLSID = IID('{6DA9D53F-4FE6-42AB-A6B9-88EB5A1A2926}')
	coclass_sources = [
	]
	coclass_interfaces = [
		_GrayColor,
...
# This CoClass is known by the name 'Photoshop.HSBColor.12'
class HSBColor(CoClassBaseClass): # A CoClass
	# An HSB color specification
	CLSID = IID('{6B4CAEF5-1043-477C-87CA-C27EF3A91CE9}')
	coclass_sources = [
	]
	coclass_interfaces = [
		_HSBColor,
...
# This CoClass is known by the name 'Photoshop.IndexedConversionOptions.12'
class IndexedConversionOptions(CoClassBaseClass): # A CoClass
	# Settings related to changing the document mode to Indexed
	CLSID = IID('{C32A7B74-655B-44DD-A870-2655FAAAEC45}')
	coclass_sources = [
	]
	coclass_interfaces = [
...
# This CoClass is known by the name 'Photoshop.JPEGSaveOptions.12'
class JPEGSaveOptions(CoClassBaseClass): # A CoClass
	# Settings related to saving a JPEG document
	CLSID = IID('{C5DD0937-8830-4F5B-A0B1-0F010F2BA763}')
	coclass_sources = [
	]
	coclass_interfaces = [
		_JPEGSaveOptions,
...
# This CoClass is known by the name 'Photoshop.LabColor.12'
class LabColor(CoClassBaseClass): # A CoClass
	# An Lab color specification
	CLSID = IID('{86D61CD0-22FE-422C-BA9E-7724EFAEE6A9}')
	coclass_sources = [
	]
	coclass_interfaces = [
		_LabColor,
...
# This CoClass is known by the name 'Photoshop.NoColor.12'
class NoColor(CoClassBaseClass): # A CoClass
	# represents a missing color
	CLSID = IID('{EB61937C-1545-4EF5-AE02-0DAAC31FC9C2}')
	coclass_sources = [
	]
	coclass_interfaces = [
		_NoColor,
...
# This CoClass is known by the name 'Photoshop.PDFOpenOptions.12'
class PDFOpenOptions(CoClassBaseClass): # A CoClass
	# Settings related to opening a generic PDF document
	CLSID = IID('{620205C8-6CC8-4B06-A1ED-25CD6993C1D6}')
	coclass_sources = [
	]
	coclass_interfaces = [
		_PDFOpenOptions,
...
# This CoClass is known by the name 'Photoshop.PDFSaveOptions.12'
class PDFSaveOptions(CoClassBaseClass): # A CoClass
	# Settings related to saving a pdf document
	CLSID = IID('{A7D0B9FD-0113-4DC1-BD85-22A5F4F0CF06}')
	coclass_sources = [
	]
	coclass_interfaces = [
		_PDFSaveOptions,
...
# This CoClass is known by the name 'Photoshop.PICTFileSaveOptions.12'
class PICTFileSaveOptions(CoClassBaseClass): # A CoClass
	# Settings related to saving a PICT document
	CLSID = IID('{04ABB7FD-89F6-4BCC-A33F-D0DCB1FA72A6}')
	coclass_sources = [
	]
	coclass_interfaces = [
...
# This CoClass is known by the name 'Photoshop.PNGSaveOptions.12'
class PNGSaveOptions(CoClassBaseClass): # A CoClass
	# Settings related to saving a PNG document
	CLSID = IID('{F71FE2A9-30F1-48F9-824B-4D0971A34355}')
	coclass_sources = [
	]
	coclass_interfaces = [
		_PNGSaveOptions,
...
# This CoClass is known by the name 'Photoshop.PathPointInfo.12'
class PathPointInfo(CoClassBaseClass): # A CoClass
	# Path point information (returned by entire path dataClassProperty of path item class)
	CLSID = IID('{7282C694-D0F9-4C96-8494-716551081A2B}')
	coclass_sources = [
	]
	coclass_interfaces = [
		_PathPointInfo,
...
# This CoClass is known by the name 'Photoshop.PhotoCDOpenOptions.12'
class PhotoCDOpenOptions(CoClassBaseClass): # A CoClass
	# Settings related to opening a PhotoCD document
	CLSID = IID('{A5320D4D-0784-4083-9ABF-E2B66E46F420}')
	coclass_sources = [
	]
	coclass_interfaces = [
		_PhotoCDOpenOptions,
...
# This CoClass is known by the name 'Photoshop.PhotoshopSaveOptions.12'
class PhotoshopSaveOptions(CoClassBaseClass): # A CoClass
	# Settings related to saving a Photoshop document
	CLSID = IID('{EFE476D2-BB9F-449B-9B6D-FE71B42A40B2}')
	coclass_sources = [
	]
	coclass_interfaces = [
...
# This CoClass is known by the name 'Photoshop.PicturePackageOptions.12'
class PicturePackageOptions(CoClassBaseClass): # A CoClass
	# options for the Picture Package command
	CLSID = IID('{B8AEDDD5-2D78-4365-9D41-14A7610A193E}')
	coclass_sources = [
	]
	coclass_interfaces = [
...
# This CoClass is known by the name 'Photoshop.PixarSaveOptions.12'
class PixarSaveOptions(CoClassBaseClass): # A CoClass
	# Settings related to saving a Pixar document
	CLSID = IID('{2774A466-12A0-4658-A019-B4D5213D9D20}')
	coclass_sources = [
	]
	coclass_interfaces = [
		_PixarSaveOptions,
...
# This CoClass is known by the name 'Photoshop.PresentationOptions.12'
class PresentationOptions(CoClassBaseClass): # A CoClass
	# options for the PDF presentation command
	CLSID = IID('{B434E847-DEAD-4AA7-8F3F-5B7DD59A7554}')
	coclass_sources = [
	]
	coclass_interfaces = [
...
# This CoClass is known by the name 'Photoshop.RGBColor.12'
class RGBColor(CoClassBaseClass): # A CoClass
	# An RGB color specification
	CLSID = IID('{F491AFF3-A34F-4BC0-BA31-E57527BB55BA}')
	coclass_sources = [
	]
	coclass_interfaces = [
		_RGBColor,
...
# This CoClass is known by the name 'Photoshop.RawFormatOpenOptions.12'
class RawFormatOpenOptions(CoClassBaseClass): # A CoClass
	# Settings related to opening a raw format document
	CLSID = IID('{340311C5-3903-400C-85B0-F966EBF9C9C8}')
	coclass_sources = [
	]
	coclass_interfaces = [
...
# This CoClass is known by the name 'Photoshop.RawSaveOptions.12'
class RawSaveOptions(CoClassBaseClass): # A CoClass
	# Settings related to saving a document in raw format
	CLSID = IID('{E7B57839-407D-4C32-B8C9-2847EFCF7555}')
	coclass_sources = [
	]
	coclass_interfaces = [
		_RawSaveOptions,
...
# This CoClass is known by the name 'Photoshop.SGIRGBSaveOptions.12'
class SGIRGBSaveOptions(CoClassBaseClass): # A CoClass
	# Settings related to saving a document in the SGI RGB format
	CLSID = IID('{BEB8EB29-7BDA-4979-995A-2215A403353D}')
	coclass_sources = [
	]
	coclass_interfaces = [
		_SGIRGBSaveOptions,
...
# This CoClass is known by the name 'Photoshop.SolidColor.12'
class SolidColor(CoClassBaseClass): # A CoClass
	# A color value
	CLSID = IID('{135F725E-9C7D-4D86-8DDB-A82997C0E702}')
	coclass_sources = [
	]
	coclass_interfaces = [
		_SolidColor,
...
# This CoClass is known by the name 'Photoshop.SubPathInfo.12'
class SubPathInfo(CoClassBaseClass): # A CoClass
	# Sub path information (returned by entire path dataClassProperty of path item class)
	CLSID = IID('{681135A5-60D1-47FB-AB03-D669CC35CD15}')
	coclass_sources = [
	]
	coclass_interfaces = [
		_SubPathInfo,
...
# This CoClass is known by the name 'Photoshop.TargaSaveOptions.12'
class TargaSaveOptions(CoClassBaseClass): # A CoClass
	# Settings related to saving a Target document
	CLSID = IID('{C3DAF984-C427-432F-8E48-996B5899436B}')
	coclass_sources = [
	]
	coclass_interfaces = [
		_TargaSaveOptions,
...
# This CoClass is known by the name 'Photoshop.TiffSaveOptions.12'
class TiffSaveOptions(CoClassBaseClass): # A CoClass
	# Settings related to saving a TIFF document
	CLSID = IID('{F2F94B1A-735E-48CD-AF5C-9034989100C8}')
	coclass_sources = [
	]
	coclass_interfaces = [
		_TiffSaveOptions,
...
CLSIDToClassMap = {
	'{8A8974AE-0BE2-4AB5-8518-94E6F27A8DC1}' : GalleryImagesOptions,
	'{0194FCAC-7ED4-4552-BAC7-BFD4D4E4FCFF}' : BMPSaveOptions,
	'{7D14BA29-1672-482F-8F48-9DA1E94800FD}' : PathPoint,
	'{C5DD0937-8830-4F5B-A0B1-0F010F2BA763}' : JPEGSaveOptions,
	...
	'{E7B57839-407D-4C32-B8C9-2847EFCF7555}' : RawSaveOptions,
	'{7282C694-D0F9-4C96-8494-716551081A2B}' : PathPointInfo,
	'{746FEF90-A182-4BD0-A4F6-BB6BBAE87A78}' : DocumentInfo,
	'{C32A7B74-655B-44DD-A870-2655FAAAEC45}' : IndexedConversionOptions,
	'{1FCF72FE-56FC-40EF-9409-3B15E524CF57}' : GallerySecurityOptions,
	...
	'{F71FE2A9-30F1-48F9-824B-4D0971A34355}' : PNGSaveOptions,
	...
	'{84EE10CC-61DD-4F8C-82EB-13198358996B}' : EPSOpenOptions,
	...
	'{F2F94B1A-735E-48CD-AF5C-9034989100C8}' : TiffSaveOptions,
	'{EFE476D2-BB9F-449B-9B6D-FE71B42A40B2}' : PhotoshopSaveOptions,
	'{7E8F9046-9F8E-4594-A22C-9F6B4C227CD7}' : _SubPathInfo,
	'{2EB2592D-F02D-4117-A22C-26E5CDFAEEE2}' : _GalleryCustomColorOptions,
	'{8F308687-025F-4FB2-8BC0-40E106E3760B}' : GalleryThumbnailOptions,
	'{69172A3F-E06E-42E6-B733-4DC36E2AC948}' : HistoryStates,
	'{66869370-9672-492D-93AC-0ADD62F427F1}' : CountItem,
	'{A5320D4D-0784-4083-9ABF-E2B66E46F420}' : PhotoCDOpenOptions,
	'{A5FDBB10-1148-4014-AC7A-A710D789AC76}' : DCS1_SaveOptions,
	'{6DA9D53F-4FE6-42AB-A6B9-88EB5A1A2926}' : GrayColor,
	'{E7A940CD-9AC7-4D76-975D-24D6BA0FDD16}' : TextItem,
	'{95D69B63-B319-44D3-8307-C988E96E7E58}' : _GallerySecurityOptions,
	'{A190F1A7-8DD0-4D60-ADC2-E1B1AE6882BD}' : DICOMOpenOptions,
	'{2F30577D-2958-428D-954D-42D78D046D9E}' : BatchOptions,
	'{D9389EDE-AEF8-4092-9377-075E94B7CB9A}' : Application,
	'{750824C6-C347-4CDB-AA96-8ABA1EBDF9EA}' : _NoColor,
	'{E68AB4B1-0182-409F-A657-1B1027B93A80}' : GalleryOptions,
	...
	'{E490EE52-1579-4440-B20F-56299E7BB000}' : ExportOptionsSaveForWeb,
	...
	'{9EE48E8D-E8C5-41B8-82D3-966D5CE4DE6E}' : ActionDescriptor,
	'{EB61937C-1545-4EF5-AE02-0DAAC31FC9C2}' : NoColor,
	'{91B5F8AE-3CC5-4775-BCD3-FF1E0724BB01}' : PathItems,
	'{0901CE4F-96EE-4C25-9FCB-34835BD80531}' : CMYKColor,
	'{340311C5-3903-400C-85B0-F966EBF9C9C8}' : RawFormatOpenOptions,
	'{28D58674-3C72-448F-A6DF-D13AAEBA90D1}' : GalleryCustomColorOptions,
	'{135F725E-9C7D-4D86-8DDB-A82997C0E702}' : SolidColor,
	'{BEB8EB29-7BDA-4979-995A-2215A403353D}' : SGIRGBSaveOptions,
	...
	'{B8AEDDD5-2D78-4365-9D41-14A7610A193E}' : PicturePackageOptions,
	...
	'{B434E847-DEAD-4AA7-8F3F-5B7DD59A7554}' : PresentationOptions,
	'{DFB392EF-085E-4576-B96C-1CB253817E36}' : BitmapConversionOptions,
	...
	'{61308800-CAE8-474E-9241-5D45EC4C0B59}' : DCS2_SaveOptions,
	'{86D61CD0-22FE-422C-BA9E-7724EFAEE6A9}' : LabColor,
	'{0D014F5C-8898-4477-B99A-4F5ACEA4E253}' : ContactSheetOptions,
	...
	'{020C962D-F4F9-4973-971F-8083C9B8D99E}' : EPSSaveOptions,
	'{D54491EF-6F09-4DE3-B49A-D57EDB2F40B8}' : _EPSSaveOptions,
	'{8B4F1F1E-4ED7-4291-AE61-76ADF4D1D50B}' : Notifier,
	'{C3DAF984-C427-432F-8E48-996B5899436B}' : TargaSaveOptions,
	'{1B28B8CD-7578-415F-AC67-DC22A69F4C07}' : _GrayColor,
	'{620205C8-6CC8-4B06-A1ED-25CD6993C1D6}' : PDFOpenOptions,
	'{DFF407C7-3BCC-45AC-B6CC-EE6D52032D85}' : _ActionReference,
	'{F0DAEE0E-C63D-4E0B-8D6A-BC6FC6886711}' : ExportOptionsIllustrator,
	...
	'{A7D0B9FD-0113-4DC1-BD85-22A5F4F0CF06}' : PDFSaveOptions,
	'{82E8A02B-F8EB-4F72-B691-4F347FB05F96}' : ActionList,
	'{2774A466-12A0-4658-A019-B4D5213D9D20}' : PixarSaveOptions,
	...
	'{DE64233A-E11D-4554-B8FD-C10642D3C779}' : ActionReference,
	'{478BF855-E42A-4D63-8C9D-F562DE5FF7A8}' : _PNGSaveOptions,
	'{681135A5-60D1-47FB-AB03-D669CC35CD15}' : SubPathInfo,
	...
	'{75BF0078-35B3-41CD-B8B6-790415C9126C}' : CameraRAWOpenOptions,

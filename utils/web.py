import os, httplib, mimetypes, mimetools, urllib2, cookielib
import fileutils
import cStringIO
import web_crawler
...
##   buf = StringIO()
    ...
    for fLst in files:
        ...
        if len(fLst)==3:
            ...
            data=fileutils.GetFileData(filename,Mode='rb')
        L.append('--' + BOUNDARY)
    ...
    fileutils.Save2File(r'c:\test1.dat',body, Mode='wb',flSmartSaving=0)
